...
window.addEventListener('load', function() {
    ...
    // mute.addEventListener("mouseover", function( event ) {
    //     // highlight the mouseover target
    //     if (mute.src.includes("sound.png") && muteClicked == false) {
    //         event.target.src = "images/sound-black.png";
    //     }
    //     if (mute.src.includes("muted.png")) {
    //         event.target.src = "images/muted-black.png";
    //     }      
    // });

    // mute.addEventListener("mouseout", function( event ) {
    //     // highlight the mouseover target
    //     if (mute.src.includes("sound-black.png")) {
    //         event.target.src = "images/sound.png";
    //     }
    //     if (mute.src.includes("muted-black.png")) {
    //         event.target.src = "images/muted.png";
    //     }
    // });
